...
class TestReportService(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.report_service = ReportService(self.report_repository)
        ...
        self.receipt_service = ReceiptService(self.receipt_repository, self.product_repository,
    ...
    def test_generate_report_with_receipts(self) -> None:
        ...
        self.product_service.create_product(product_id="1", name="apple", barcode="1234567890", price=5.0)
        self.receipt_service.add_product_to_receipt(receipt_id="1", product_id="1", quantity=2)
        self.receipt_service.close_receipt(receipt_id="1")

        self.receipt_service.create_receipt(receipt_id="2", shift_id="1")
        self.product_service.create_product(product_id="2", name="Banana", barcode="0987654321", price=7.0)
        self.receipt_service.add_product_to_receipt(receipt_id="2", product_id="2", quantity=1)
        self.receipt_service.close_receipt(receipt_id="2")

        self.receipt_service.create_receipt(receipt_id="3", shift_id="2")
        self.receipt_service.add_product_to_receipt(receipt_id="3", product_id="1", quantity=1)
        self.receipt_service.add_product_to_receipt(receipt_id="3", product_id="2", quantity=1)
        self.receipt_service.close_receipt(receipt_id="3")

        self.receipt_service.create_receipt(receipt_id="4", shift_id="2")
        self.product_service.create_product(product_id="45", name="book", barcode="0987600321", price=15.0)
        self.receipt_service.add_product_to_receipt(receipt_id="4", product_id="45", quantity=1)
